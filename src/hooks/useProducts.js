export default function handler(req, res) {
  // PLAN B: Cuando tengas la URL real de Dux, cambiaremos esto.
  // Por ahora, esta API de Vercel le devuelve el catálogo de prueba a tu web 
  // simulando que la info vino de Dux para destrabar el frontend.
  ...
  return res.status(200).json({ productos: mockProducts });
}